...
class _ToolsScreenState extends State<ToolsScreen> {
  ...
  void _showDateConverter(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => const DateConverterWidget(),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            ...
            child: Text(secondBirthDate != null ? 'تاریخ تولد دوم انتخاب شده' : 'انتخاب تاریخ تولد دوم (اختیاری)'),
          ),
